...
void Port_Init(const Port_ConfigType* ConfigPtr )
{
    ...
    else if(&Port_Configuration != ConfigPtr)
    {
#if (STD_ON == PORT_DEV_ERROR_DETECT)
...
void Port_SetPinDirection ( Port_PinType Pin , Port_PinDirectionType Direction )
{
    ...
    else if (PORT_NOT_INITIALIZED == Port_Status)
    {
#if (STD_ON == PORT_DEV_ERROR_DETECT)
    ...
    else if (DIRECTION_NOT_CHANGEABLE == Port_Configuration.Pins[Pin].Pin_Direction_Changeable)
    {
#if (STD_ON == PORT_DEV_ERROR_DETECT)
...
void Port_SetPinMode(  Port_PinType Pin,  Port_PinModeType Mode )
{
    ...
    else if (MODE_NOT_CHANGEABLE == Port_Configuration.Pins[Pin].Pin_Mode_Changeable)
    {
#if (STD_ON == PORT_DEV_ERROR_DETECT)
