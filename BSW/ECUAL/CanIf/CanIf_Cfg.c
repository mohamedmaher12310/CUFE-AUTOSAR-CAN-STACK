...
/* Include CanIf_Cfg Header Filer*/
#include "CanIf.h"
...
const CanIf_ConfigType CanIf_Configuration =
{
 .CanIfCtrlDrvCfg =
 {
  .CanIfCtrlDrvInitHohConfigRef = (CanIfInitHohCfg*)&CanIf_Configuration.CanIfInitCfg.CanIfInitHohCfg[CAN_INSTANCE_ID],
 ...
 .CanIfInitCfg =
 {
  .CanIfBufferCfg =
  {
   {
    .CanIfBufferSize = 1,
    .CanIfBufferHthRef = (CanIfHthCfg*)&CanIf_Configuration.CanIfInitCfg.CanIfInitHohCfg[CAN_INSTANCE_ID].CanIfHthCfg[HTH0_ID]
   },
   {
    .CanIfBufferSize = 1,
    .CanIfBufferHthRef = (CanIfHthCfg*)&CanIf_Configuration.CanIfInitCfg.CanIfInitHohCfg[CAN_INSTANCE_ID].CanIfHthCfg[HTH1_ID]
   },
   {
    .CanIfBufferSize = 1,
    .CanIfBufferHthRef = (CanIfHthCfg*)&CanIf_Configuration.CanIfInitCfg.CanIfInitHohCfg[CAN_INSTANCE_ID].CanIfHthCfg[HTH2_ID]
   }
  },
  ...
  {
   {
    ...
    .CanIfTxPduBufferRef = (CanIfBufferCfg*)&CanIf_Configuration.CanIfInitCfg.CanIfBufferCfg[HTH0_ID]
   },
   {
  ...
  .CanIfRxPduCfg =
  {
   ...
   },
   {
    ...
    .CanIfRxPduHrhIdRef= (CanIfHrhCfg*)&CanIf_Configuration.CanIfInitCfg.CanIfInitHohCfg[CAN_INSTANCE_ID].CanIfHrhCfg[HRH1_ID],
#if(STD_ON == CanIfPublicReadRxPduNotifyStatusApi)
    .CanIf_RxPduReadNotifyStatus=TRUE,
#endif /*CanIfPublicReadRxPduNotifyStatusApi */
    .CanIfRxPduCanIdType = STANDARD_CAN_Rx,
