...
#include "../../MCAL/CanDrv/Can_GeneralTypes.h"
...
typedef struct
{
    ...
    /* container contains parameters related to each HRH*/
...
typedef struct
{
    ...
    /*Reference to HTH, it defines the hardware object or the pool of hardware objects configured for transmission*/
...
typedef struct
{
    ...
    /*container contains the references to the configuration setup of each underlying CAN Driver.*/
    CanIfInitHohCfg CanIfInitHohCfg[Can_DRIVERS_NUMBER];
    /*This container contains the init parameters of the CAN Interface.*/
    CanIfTxPduCfg CanIfTxPduCfg[CanIfMaxTxPduCfg];
    /*container contains the configuration (parameters) of each receive CAN L-PDU.*/
...
typedef struct
{
    ...
    /*Sub-Container contains the configuration (parameters) of an adressed CAN controller by an underlying CAN Driver module*/
...
typedef struct
{
    /*Sub-Containers contains configuration parameters for all the underlying CAN Driver modules*/
